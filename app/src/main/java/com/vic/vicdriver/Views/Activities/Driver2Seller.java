...
public class Driver2Seller extends AppCompatActivity implements View.OnClickListener {
    ...
    public static int driverSellerOrderId = 0;

    public static boolean isd2sChatActive= false;
    private boolean isSendingMessage = false;

    private BroadcastReceiver chatBroadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("Driver2SellerBroadCast")) {
                try {
                    JSONObject jsonObject = new JSONObject(intent.getStringExtra("messageData"));

                    if (driverSellerOrderId == jsonObject.getInt("order_id")) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(Driver2Seller.this).registerReceiver(chatBroadcastReceiver, new IntentFilter("Driver2SellerBroadCast"));
        isd2sChatActive= true;

        driverSellerOrderId = getIntent().getIntExtra("orderId", 0);

        if (driverSellerOrderId > 0) {
            initViews();
            setAdapter();
        } else {
            Common.showToast(Driver2Seller.this, getResources().getString(R.string.something_is_not_right), false);
    ...
    private void setAdapter() {
        chatAdapter = new ChatAdapter(Driver2Seller.this, datumArrayList);
        layoutManager = new LinearLayoutManager(Driver2Seller.this);
        ...
        Common.showDialog(Driver2Seller.this);
    ...
    private void settingRecordViewListener() {
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                if (ContextCompat.checkSelfPermission(Driver2Seller.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_DENIED
                        || ContextCompat.checkSelfPermission(Driver2Seller.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(Driver2Seller.this, new String[]{Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 2003);
                } else {
            ...
            public void onCancel() {
                ...
                if (ContextCompat.checkSelfPermission(Driver2Seller.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED
                        || ContextCompat.checkSelfPermission(Driver2Seller.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    shutDownRecorder();
                }
            }
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(Driver2Seller.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(Driver2Seller.this, new String[]{permission}, requestCode);
        } else {
    ...
    private void getMessageFromApi(int c) {
        ...
        Call<ChatModel> call = api.getDriverSellerMessages("Bearer " + SharedPreference.getSimpleString(Driver2Seller.this, Constants.accessToken),
                driverSellerOrderId, c);
        ...
        call.enqueue(new Callback<ChatModel>() {
            ...
            public void onResponse(Call<ChatModel> call, Response<ChatModel> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        Common.showToast(Driver2Seller.this, jsonObject.getString("message"), false);
                        showNullMessage();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void onFailure(Call<ChatModel> call, Throwable t) {
                Common.dissmissDialog();
                Log.d("Driver2Seller", "onFailure: " + t.getMessage());
                showNullMessage();
            }
        });
    ...
    private void postMessage(String message, File file, String type, String duration) {
        ...
        RequestBody rbOrderId = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(driverSellerOrderId));
        ...
        if (type.equals("text")) {
            ...
            call = api.postTextMessageDriverSeller("Bearer " + SharedPreference.getSimpleString(Driver2Seller.this, Constants.accessToken),
            ...
            call = api.postFileMessageDriverSeller("Bearer " + SharedPreference.getSimpleString(Driver2Seller.this, Constants.accessToken),
    ...
    protected void onDestroy() {
        super.onDestroy();
        LocalBroadcastManager.getInstance(Driver2Seller.this).unregisterReceiver(chatBroadcastReceiver);
        stopAudio();
    }
